...
export class FollowerService {
  ...
  public followerIdDelete(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling followerIdDelete.'
      );
    }
  ...
  public followerIdGet(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling followerIdGet.'
      );
    }
    ...
    return this.httpClient.request<Follower>(
      'get',
      `${this.basePath}/Follower/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
